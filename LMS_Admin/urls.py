...
urlpatterns = [
    ...
    url(r'^unit/', include([
        ...
        url(r'^(?P<unit_id>[0-9]+)/', include([
            ...
            url(r'^class/', include([
                url(r'^$', views.ClassListView.as_view(), name='unit_class'),
                url(r'^add/$', views.ClassAddView.as_view(), name='unit_class_add'),
                url(r'^(?P<class_id>[0-9]+)/', include([
                    url(r'^$', views.ClassEditView.as_view(), name='unit_class_edit'),
                    url(r'^delete/$', views.ClassDeleteView.as_view(), name='unit_class_delete'),
                ])),
            ])),
        ])),
    ])),
